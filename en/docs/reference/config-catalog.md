                        ...
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>This configuration should be used only if it is required to change the SameSite attribute of all the cookies to the configured value. Note that this configuration is available in wso2am-4.6.0 starting from update level 12 and wso2am-acp-4.6.0 starting from update level 13.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
